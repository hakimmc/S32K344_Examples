...
/**
* @brief          Symbolic name for the channel RGBLED1_GREEN.
*
*/
#define DioConf_DioChannel_RGBLED1_GREEN  ((uint16)0x0039U)
/**
* @brief          Symbolic name for the channel RGBLED1_RED.
*
*/
#define DioConf_DioChannel_RGBLED1_RED  ((uint16)0x0032U)
/**
...
/**
* @brief          Symbolic name for the channel CAN0_EN_NXP.
*
*/
#define DioConf_DioChannel_CAN0_EN_NXP  ((uint16)0x005eU)
/* ---------- PTD_L ---------- */
...
/**
* @brief          Symbolic name for the channel CanController_1_EN.
*
*/
#define DioConf_DioChannel_CanController_1_EN  ((uint16)0x006fU)
/**
* @brief          Symbolic name for the channel CanController_1_STB.
*
*/
#define DioConf_DioChannel_CanController_1_STB  ((uint16)0x006dU)
/* ---------- PTE_L ---------- */
...
/**
* @brief          Symbolic name for the channel CanController_1_ERRN.
*
*/
#define DioConf_DioChannel_CanController_1_ERRN  ((uint16)0x0088U)
/**
* @brief          Symbolic name for the channel RGBLED1_BLUE.
*
*/
#define DioConf_DioChannel_RGBLED1_BLUE  ((uint16)0x008cU)
/* ---------- PTG_L ---------- */
...
/**
* @brief          Symbolic name for the channel CAN0_STB_NXP.
*
*/
#define DioConf_DioChannel_CAN0_STB_NXP  ((uint16)0x00ccU)
